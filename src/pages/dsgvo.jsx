    ...
    <Layout pageTitle="Datenschutzerklärung">
      <div className={standardContent}>
        ...
        <p>
          ...
          Stellenwert für die Geschäftsleitung der Hellermann Transporte e.K.. Eine Nutzung der Internetseiten der
          Hellermann Transporte e.K. ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine
          betroffene Person besondere Services unseres Unternehmens über unsere Internetseite in Anspruch nehmen möchte,
        ...
        <p>
          ...
          Übereinstimmung mit den für die Hellermann Transporte e.K. geltenden landesspezifischen
          Datenschutzbestimmungen. Mittels dieser Datenschutzerklärung möchte unser Unternehmen die Öffentlichkeit über
          Art, Umfang und Zweck der von uns erhobenen, genutzten und verarbeiteten personenbezogenen Daten informieren.
          Ferner werden betroffene Personen mittels dieser Datenschutzerklärung über die ihnen zustehenden Rechte
          aufgeklärt.
        </p>

        <p>
          Die Hellermann Transporte e.K. hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
        ...
        <p>
          Die Datenschutzerklärung der Hellermann Transporte e.K. beruht auf den Begrifflichkeiten, die durch den
        ...
        <p>Hellermann Transporte e.K.</p>
        <p>Im Kleinfeld 13</p>
        <p>76646 Bruchsal</p>
        <p>Deutschland</p>
        <p>Tel.: +4917619450998</p>
        <p>E-Mail: info@hellermann-transporte.de</p>
        <p>Website: www.hellermann-transporte.de</p>

        <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
        <p>
          Die Internetseite der Hellermann Transporte e.K. erfasst mit jedem Aufruf der Internetseite durch eine
          betroffene Person oder ein automatisiertes System eine Reihe von allgemeinen Daten und Informationen. Diese
          allgemeinen Daten und Informationen werden in den Logfiles des Servers gespeichert. Erfasst werden können die
          (1) verwendeten Browsertypen und Versionen, (2) das vom zugreifenden System verwendete Betriebssystem, (3) die
          Internetseite, von welcher ein zugreifendes System auf unsere Internetseite gelangt (sogenannte Referrer), (4)
          die Unterwebseiten, welche über ein zugreifendes System auf unserer Internetseite angesteuert werden, (5) das
        ...
        <p>
          Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Hellermann Transporte e.K. keine
          ...
          und Informationen werden durch die Hellermann Transporte e.K. daher einerseits statistisch und ferner mit dem
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              personenbezogenen Daten, die bei der Hellermann Transporte e.K. gespeichert sind, veranlassen möchte, kann
              sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter der Hellermann Transporte e.K. wird veranlassen, dass dem Löschverlangen unverzüglich
              nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von der Hellermann Transporte e.K. öffentlich gemacht und ist unser
              Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
              verpflichtet, so trifft die Hellermann Transporte e.K. unter Berücksichtigung der verfügbaren Technologie
              ...
              Der Mitarbeiter der Hellermann Transporte e.K. wird im Einzelfall das Notwendige veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              von personenbezogenen Daten, die bei der Hellermann Transporte e.K. gespeichert sind, verlangen möchte,
              kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter der Hellermann Transporte e.K. wird die Einschränkung der Verarbeitung veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              einen anderen Verantwortlichen übermittelt werden, soweit dies technisch machbar ist und sofern hiervon
            ...
            <p>
              ...
              Mitarbeiter der Hellermann Transporte e.K. wenden.
            </p>
          </li>
          <li>
            ...
            <p>
              Die Hellermann Transporte e.K. verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht
            ...
            <p>
              Verarbeitet die Hellermann Transporte e.K. personenbezogene Daten, um Direktwerbung zu betreiben, so hat
              die betroffene Person das Recht, jederzeit Widerspruch gegen die Verarbeitung der personenbezogenen Daten
              zum Zwecke derartiger Werbung einzulegen. Dies gilt auch für das Profiling, soweit es mit solcher
              Direktwerbung in Verbindung steht. Widerspricht die betroffene Person gegenüber der Hellermann Transporte
              e.K. der Verarbeitung für Zwecke der Direktwerbung, so wird die Hellermann Transporte e.K. die
            ...
            <p>
              ...
              gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der Hellermann Transporte e.K. zu
            ...
            <p>
              ...
              Hellermann Transporte e.K. oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es ferner
          ...
          <li>
            ...
            <p>
              ...
              betroffenen Person, trifft die Hellermann Transporte e.K. angemessene Maßnahmen, um die Rechte und
